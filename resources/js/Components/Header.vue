<template>
    <header id="header">
        <div class="header">
            ...
            <div class="hd_ri">
                <ul class="hd_nav">
                    <li><a href="/contents/planning">ABOUT</a></li>
                    <li><a href="/portfolios">PORTFOLIO</a></li>
                    <li><a href="/columns">COLUMN</a></li>
                    <li><a href="/qnas/create">CONTACT</a></li>
                </ul>
            ...
            <div class="sub_nav_wrap">
                <div class="flex_wrap">
                    <ul class="big_nav">
                        <li class="now">About</li>
                        <li>Portfolio</li>
                        <li>Column</li>
                        <li>Contact</li>
                    </ul>
                    <div class="small_nav_wrap">
                        <ul class="now">
                            <li><a href="/contents/planning">홈페이지 기획</a></li>
                            <li><a href="/contents/design">홈페이지 디자인</a></li>
                            <li><a href="/contents/front">홈페이지 프론트</a></li>
                            <li><a href="/contents/backend">홈페이지 백엔드</a></li>
                        </ul>
                        <ul>
                        ...
                        <ul>
                            ...
                            <!--
                            <li><a href="../Survey.html" target="_blank">1분 문답 시작하기</a></li>
                            -->
                        </ul>
                        <div class="num_wrap">
                            <h3>바로 문의</h3>
